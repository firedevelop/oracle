...
BEGIN
  SELECT employee_id, first_name, salary, commission_pct
    ...
    FROM hr.employees
    WHERE employee_id = v_id; -- Replace with your desired employee ID
...
END;
/
-- SELECT employee_id, first_name, salary, commission_pct FROM hr.EMPLOYEES WHERE EMPLOYEE_ID = &id;
